...
@onready var sfx_slider = $MarginContainer/VBoxContainer/HBoxContainer/SfxSlider
@onready var music_slider = $MarginContainer/VBoxContainer/HBoxContainer/MusicSlider
